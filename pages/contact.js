                ...
                <SimpleGrid columns={{base: 1, lg: 2}} gap={{base: 4, md: 6}} my={6}>
                  <Flex flexDir={'column'} gap={4}>
                    <SimpleGrid columns={{base: 1, md: 2}} gap={4}>
                      <CustomInput name={'firstName'} label={'First Name'} placeholder={'John'} type={'text'}
                                   styles={customStyle}/>
                      <CustomInput name={'lastName'} label={'Last Name'} placeholder={'Doe'} type={'text'}
                                   styles={customStyle}/>
                    </SimpleGrid>
                    <CustomInput name={'email'} label={'Email'} placeholder={'johndoe@gmail.com'} type={'email'}
                                 styles={customStyle}/>
                    <CustomInput name={'phone'} label={'Phone Number'} type={'number'} styles={customStyle}/>
                    <CustomInput name={'message'} label={'Message'} placeholder={'Please specify how can we help you?'}
                                 type={'text'} as={'textarea'} rows={5} styles={customStyle}/>
                    <CustomSelect name={'labels'} label={'Select Labels'} options={labelOptions}
                                  placeholder={'Select Labels...'} styles={customStyle}/>
                  </Flex>
                  <Box>
                    {/*<ClusterMap/>*/}
